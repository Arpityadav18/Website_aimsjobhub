...
const Header = () => {
  ...
  return (
    ...
    <nav className={`${darkMode? 'dark bg-black':'light bg-gray-700'} flex justify-between items-center gap-4 lg:px-20 px-4 py-3 sticky top-0 z-30`}>
      <div id = 'logo'>
  
<img src={logo} alt="company logo" className='lg:w-[150px] w-[120px] dark:invert' />   </div>
